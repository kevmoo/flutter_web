  ...
  void _debugReserveFor(Element parent) {
    assert(() {
      ...
      if (_debugReservations.containsKey(this) &&
        ...
        if (older != newer) {
          throw FlutterError('Multiple widgets used the same GlobalKey.\n'
...
abstract class ParentDataWidget<T extends RenderObjectWidget>
  ...
  String debugDescribeInvalidAncestorChain(
      {String description,
    ...
    try {
      ...
      assert(() {
        if (_dirtyElements
          ...
          throw FlutterError('buildScope missed some dirty elements.\n'
...
abstract class Element extends DiagnosticableTree implements BuildContext {
  ...
  void visitChildElements(ElementVisitor visitor) {
    assert(() {
      ...
      throw FlutterError('visitChildElements() called during build.\n'
  ...
  Size get size {
    assert(() {
      if (_debugLifecycleState != _ElementLifecycle.active) {
        throw FlutterError('Cannot get size of inactive element.\n'
      ...
      if (owner._debugBuilding) {
        throw FlutterError('Cannot get size during build.\n'
    ...
    assert(() {
      if (renderObject == null) {
        throw FlutterError('Cannot get size without a render object.\n'
      ...
      if (renderObject is RenderSliver) {
        throw FlutterError('Cannot get size from a RenderSliver.\n'
